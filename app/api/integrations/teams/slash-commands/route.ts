...
export async function POST(request: NextRequest) {
  try {
    ...
    // Execute command
    const result = await executeSlashCommand(command, action, args, "microsoft-teams", payload)
    
    // Generate response
    const responseText = generateCommandResponse(command, action, result, "microsoft-teams")
    ...
    console.error("Teams slash command error:", error)
...
async function executeSlashCommand(
  ...
  switch (command) {
      ...
      switch (action) {
        case "schedule":
          ...
          const scheduleRequest = {
            ...
            attendees: [], // Teams will populate this
    ...
    case "/meeting":
      switch (action) {
        case "start":
          // In a real implementation, this would start monitoring the current meeting
          return { status: "started" }

        case "stop":
          // In a real implementation, this would stop monitoring and generate summary
    ...
    case "/brief":
      switch (action) {
        case "pre":
          // Generate pre-brief for upcoming meeting
        ...
        case "post":
          // Generate post-brief for completed meeting
